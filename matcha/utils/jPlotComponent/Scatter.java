...
public class Scatter extends PlotComponent{
    ...
    public Scatter(jPlot plt, double[] xs, double ys[], Map<String, Object> config){
        init();
        m_plt = plt;
        m_x = xs;
        m_y = ys;
    ...
    private void scatter(Graphics g){
        ...
        if ((boolean) m_config.get("fill")){
            g2d.setColor((Color) m_config.get("fill_color"));
        ...
        if ((boolean) m_config.get("outline")){
            g2d.setColor((Color) m_config.get("outline_color"));
    ...
    public Map<String, Object> init(){
        ...
        config.put("outline_color", Color.BLACK);
